...
Standardized, CCP-cleared derivatives. Daily mark-to-market creates cash flow drag/benefit vs forward pricing (convexity adjustment). See venue-specific docs for margin rates and settlement methods.
...
See `references/flow_interpretation.md` [[futures/references/flow_interpretation.md|flow_interpretation.md]] for decision tree and thresholds.
...
See `references/spreads.md` [[futures/references/spreads.md|spreads.md]] for spread mechanics.
See `references/flow_interpretation.md` [[futures/references/flow_interpretation.md|flow_interpretation.md]] for flow analysis framework.
